...
/*!
 * Connect - Redis
 * Copyright(c) 2016 fanhai inc <fanhaitech@qq.com>
 * MIT Licensed
 */
...
var redis = require('ioredis')
  , debug = require('debug')('connect:ioredis');
...
module.exports = function(connect){
  ...
  function RedisStore(options) {
    ...
    if (options.client) {
      ...
      this.client = new Redis(options.socket, options);
    } else if (options.hosts) {
      // cluster options, prior to sentinels
      this.client = new Redis.Cluster(options.hosts, options);
